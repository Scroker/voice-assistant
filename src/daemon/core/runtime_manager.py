...
class DaemonRuntimeManager:
    ...
    def initialize_services(self):
        ...
        self.owner.tts_manager = TTSServiceManager(audio_player=self.owner.audio_player)
        ...
        self.owner.llm_service = LLMServiceManager(settings_observer=self.owner, mcp_manager=self.owner.mcp_manager)
