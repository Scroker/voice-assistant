...
class DaemonOwner(Protocol):
    ...
    speaker_id_controller: Any           # core.speaker_runtime.SpeakerIdController | None
    _speaker_session: Any                 # services.speaker_id.VoiceSpeakerSession | None
    ...
    def DependencyRequired(self, package: str, description: str, is_critical: bool) -> None: ...
    def SpeakerEnrollmentProgress(self, progress: float, level: float) -> None: ...
    def SpeakerEnrollmentFinished(self, success: bool, profile_id: str, message: str) -> None: ...
    def SpeakerIdentified(self, profile_name: str, score: float, status: str, overlap_detected: bool) -> None: ...
    def SpeakerRejected(self, reason: str, message: str) -> None: ...
